<template>
  <div class="form">
    ...
    <br>
    <div>
      <label style="color:green">绑定到a：<input type="radio" v-model="pick1" v-bind:value="a"></label>
    </div>

    <div>
      <label style="color:green">绑定到对象：<input type="radio" v-model="pick2" v-bind:value="obj"></label>
    </div>
